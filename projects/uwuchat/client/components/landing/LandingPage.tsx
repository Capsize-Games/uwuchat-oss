import { Code2, Download, Search, Shield, Sparkles } from "lucide-react";
      ...
      <main className="landing-page">
        <section className="landing-hero">
          ...
          <div className="landing-hero-actions">
            <a className="btn landing-btn-primary" href={REPO} target="_blank" rel="noreferrer"><Code2 size={18} />{text("landing.oss.github", "Get UwUchat on GitHub")}</a>
        ...
        <section className="landing-features landing-oss-grid">
          ...
          <div className="landing-feature-card"><div className="landing-feature-icon" data-hue="green"><Search size={24} /></div><h2 className="landing-feature-title">{text("landing.oss.search_title", "Optional web search")}</h2><p className="landing-feature-desc">{text("landing.oss.search_desc", "Use the built-in web search provider when you want current information.")}</p></div>
        ...
        <section className="landing-steps">
          ...
          <div className="landing-steps-grid">
            ...
            <div><strong>2</strong><h3>{text("landing.oss.step_two", "Choose your providers")}</h3><p>{text("landing.oss.step_two_desc", "Add your model provider and enable web search if you need it.")}</p></div>
        ...
        <section className="landing-cta"><h2 className="landing-cta-title">{text("landing.oss.cta_title", "Make it yours.")}</h2><p className="landing-cta-sub">{text("landing.oss.cta_subtitle", "UwUchat is free to use and open to contributions.")}</p><a className="btn landing-btn-primary landing-btn-lg" href={REPO} target="_blank" rel="noreferrer"><Code2 size={20} />{text("landing.oss.cta", "View the project on GitHub")}</a></section>
      </main>
    </PublicShell>
  );
}
