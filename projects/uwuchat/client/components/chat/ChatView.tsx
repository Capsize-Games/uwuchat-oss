...
export default function ChatView({
  ...
  type RightPanel =
    | { type: "user-profile" }
    | { type: "contacts" }
    | { type: "admin"; panel: "fastsearch" | "users" | "reports" | "calendar" | "costs" | "waitlist" }
  ...
  return (
    ...
    {(rightPanel !== null || !isMobile) && (
      <div className={isMobile ? styles.panelWrapMobile : styles.panelWrap}>
        ...
        {rightPanel && rightPanel.type !== "contacts" && rightPanel.type !== "user-profile" && (
          <PanelHeader
            compact={isMobile}
            panelTitle={
