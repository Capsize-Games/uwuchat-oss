    ...
    >
      ...
      >
        ...
        <div className="flex-grow-1 d-flex align-items-center justify-content-center">
          <img src={imageBlobUrl ?? undefined} alt={currentImg.id} className={styles.img} />
        </div>

        <div className={`d-flex flex-column flex-shrink-0 ${styles.sidebar}`}>
          <div className={`flex-shrink-0 ${styles.header}`}>
            <div className={styles.title}>{currentImg.id}</div>
