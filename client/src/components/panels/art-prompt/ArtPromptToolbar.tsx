...
import styles from "./ArtPromptToolbar.module.css";
...
export default function ArtPromptToolbar() {
  ...
  return (
    <div
      className={`d-flex align-items-center flex-wrap flex-shrink-0 border-t-subtle border-b-subtle ${styles.toolbar}`}
    >
      {loading && (
        <div
      ...
      <select
        className={`form-select form-select-sm ${styles.select1}`}
        value={version}
        disabled={loading}
      ...
      <select
        className={`form-select form-select-sm ${styles.select2}`}
        value={modelPath}
      ...
      <select
        className={`form-select form-select-sm ${styles.select3}`}
        value={scheduler}
