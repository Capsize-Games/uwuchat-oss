...
export const EVENT_ROOM_MESSAGE = "room_message";
export const EVENT_HEADLESSCODE_SESSION = "headlesscode_session";
export const EVENT_HEADLESSCODE_PROJECTS = "headlesscode_projects";
export const EVENT_UWU_CREATION = "uwu_creation";
