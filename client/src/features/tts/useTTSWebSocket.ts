...
function wsUrl(): string {
  ...
  // Token in the query string so the server binds the tenant for any
  // per-tenant settings reads; without it they hit tenant_anonymous.
  return `${proto}://${wsHost()}/api/v1/tts/ws${wsTokenSuffix()}`;
}
