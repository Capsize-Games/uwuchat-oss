...
from airunner_services.contract_enums import ModelService, ModelStatus, ModelType
...
class ModelDownloadMixin:
    ...
    def _get_model_info(self, repo_id: str) -> Optional[Dict]:
        ...
        model_id = LLMProviderConfig.get_model_id_for_repo_id(
            ModelService.LOCAL.value, repo_id
        )
        if model_id:
            return LLMProviderConfig.get_model_info(
