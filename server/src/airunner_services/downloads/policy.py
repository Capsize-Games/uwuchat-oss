...
SERVICE_DEEPINFRA_KEY = "privacy/allow_deepinfra"
...
_SERVICE_DEFAULTS = {
    ...
    SERVICE_OPENMETEO_KEY: True,
    SERVICE_OPENROUTER_KEY: True,
    SERVICE_DEEPINFRA_KEY: True,
}
...
def is_deepinfra_allowed() -> bool:
    """Return whether DeepInfra access is allowed."""
    return is_service_allowed(SERVICE_DEEPINFRA_KEY)
