"""Cloud package — API-based inference code for cloud deployments.

This package contains code that calls external inference APIs (OpenRouter,
Ollama, OpenAI, fal.ai, WaveSpeedAI, etc.). It does NOT depend on local
model weights, torch, diffusers, transformers, or any GPU-required library.

This package is NOT loaded in edge-only deployments.
"""
