...
# fetched from arxiv.org -- untrusted network input. It doesn't
# re-export the full ElementTree API, so ``ET`` above is still used
# for ParseError/traversal -- only parsing goes through defusedxml.
