...
class ApplicationSettings(BaseModel):
    ...
    hf_api_key_read_key = Column(UserEncryptedText, nullable=True)
    hf_api_key_write_key = Column(UserEncryptedText, nullable=True)
    civit_ai_api_key = Column(UserEncryptedText, nullable=True)
    openai_api_key = Column(UserEncryptedText, nullable=True)
    ...
    knowledge_base_db_migrated = Column(Boolean, default=False)
