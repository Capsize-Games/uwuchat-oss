...
class Conversation(BaseModel):
    ...
    __table_args__ = (
        Index(
            "ix_conversations_chatbot_id_id_desc", "chatbot_id", desc("id"),
        ),
    )
    ...
    value = Column(UserEncryptedText, nullable=False, default={})
    ...
    summary = Column(UserEncryptedText, nullable=True)
    ...
    def formatted_messages(self) -> str:
        ...
        if not isinstance(messages, list):
            ...
            _log.error(
                "Conversation.formatted_messages: conversation %s "
                "returned non-list value (type=%s). This indicates "
    ...
    def create(
        ...
        try:
            row = (
                cls.objects.query(cls.chatbot_id, cls.user_id)
