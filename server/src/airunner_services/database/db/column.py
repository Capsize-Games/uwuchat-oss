...
def set_default_and_create_fk(
    ...
    Migration-authoring utility only -- no call site in this
    codebase is reachable from user input; every argument is a
    literal a migration author writes by hand.
    """
    op.execute(f"""
        UPDATE {table_name}
