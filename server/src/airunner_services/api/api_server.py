...
class APIServer:
    ...
    def start(self):
        ...
        config = uvicorn.Config(
            ...
            ws_max_size=16 * 1024 * 1024,  # 16 MiB — room for large
            # canvas documents (Konva JSON) while preventing memory
            # exhaustion from maliciously oversized frames.
            # See wiki/security-posture.md §3 (Rate Limiting).
        )
