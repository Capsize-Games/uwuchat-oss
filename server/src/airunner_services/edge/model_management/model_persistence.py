...
def persist_trigger_words(
    ...
    try:
        ...
        from airunner_services.database.models.aimodels import AIModels
...
def _persist_model_trigger_words(
    ...
    # Ensure both ends of the relationship are registered before using
    # AIModels to avoid SQLAlchemy registry resolution errors.
    import importlib
    importlib.import_module(
        "airunner_services.database.models.generator_settings"
    )
