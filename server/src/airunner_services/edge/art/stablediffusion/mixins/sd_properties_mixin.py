...
from airunner_services.edge.art.stablediffusion.rect import Rect
from airunner_services.edge.art.stablediffusion import prompt_utils
...
class SDPropertiesMixin:
    ...
    def hardware_profiler(self) -> Any:
        ...
        """
        from airunner_services.edge.art.stablediffusion.memory_utils import (
