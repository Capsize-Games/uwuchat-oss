...
from airunner_services.edge.art.stablediffusion import model_loader
from airunner_services.edge.art.runtime_enums import ModelStatus, ModelType
    ...
    def _load_safety_checker(self):
        ...
        try:
            ...
            if should_download_checker:
                ...
                from airunner_services.edge.art.runtime_enums import SignalCode
            ...
            self._feature_extractor = CLIPImageProcessor.from_pretrained(  # nosec B615
                safety_checker_path,
                local_files_only=AIRUNNER_LOCAL_FILES_ONLY,
            )
