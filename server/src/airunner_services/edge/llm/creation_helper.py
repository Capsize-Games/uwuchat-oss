...
from airunner_services.edge.llm.chat_gguf_model_metadata import (
...
from airunner_services.llm.runtime_config import LocalRuntimeConfig
from airunner_services.edge.llm.local_gguf_resolution import (
    has_valid_gguf_path,
    local_gguf_state,
    resolve_gguf_path,
