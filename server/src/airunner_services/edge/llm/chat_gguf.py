...
from airunner_services.settings import AIRUNNER_LOG_LEVEL, AIRUNNER_MAX_TOKENS
from airunner_services.edge.llm.chat_gguf_execution_mixin import (
    ChatGGUFExecutionMixin,
)
from airunner_services.edge.llm.chat_gguf_chat_format_detection import (
    _detect_chat_format,
)
from airunner_services.edge.llm.chat_gguf_prompt_mixin import (
    ChatGGUFPromptMixin,
)
from airunner_services.edge.llm.chat_gguf_runtime_mixin import (
    ChatGGUFRuntimeMixin,
)
from airunner_services.edge.llm.chat_gguf_tool_parsing_mixin import (
...
class ChatGGUF(
    ...
    use_yarn: bool = False
    yarn_orig_ctx: int = AIRUNNER_MAX_TOKENS
